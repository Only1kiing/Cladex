    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[#0a0a0f] overflow-hidden px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">Welcome to Cladex</h1>
          <p className="text-sm text-gray-500">Autonomous AI trading, in one click.</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#111118]/80 backdrop-blur-xl p-6 space-y-3">
          ...
          {/* Connect Wallet — disabled, coming soon */}
          <button
            disabled
          ...
          {loading && (
            <p className="text-[11px] text-gray-500 text-center pt-2">Signing you in...</p>
          )}
        ...
        <p className="mt-6 text-center text-[11px] text-gray-600">
          By continuing you agree to Cladex&apos;s{' '}
