      ...
      <div className="rounded-xl border border-[#1e1e2e] bg-[#111118] overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <svg className={`w-3.5 h-3.5 text-gray-500 transition-transform duration-200 ${listOpen ? 'rotate-180' : ''}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className={`overflow-hidden transition-all duration-300 ease-out ${listOpen ? 'max-h-[300px] border-t border-white/[0.04]' : 'max-h-0'}`}>
